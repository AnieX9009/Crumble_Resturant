        ...
        <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                <TouchableOpacity
                    ...
                    <Text style={{ fontSize: 14, fontFamily: 'Sen-SemiBold', color: showNotification === "Notification" ? "#FB6D3A" : "#A5A7B9" }}>
                        Notification</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[styles.button, showNotification && styles.buttonActive]}
                ...
                >
                    <Text style={{ fontSize: 14, fontFamily: 'Sen-SemiBold', color: showNotification === "Messages" ? "#FB6D3A" : "#A5A7B9" }}>Messages</Text>
                </TouchableOpacity>
            </View>
